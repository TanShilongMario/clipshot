...
- 叙事影片、广告、MV、短剧的镜头拆解
- 画面调度、运镜、转场和单格放大
- 动作摄影：荷兰角、黄金分割、框内切分、极端切边，以及连续运镜的起止关键帧
- 导演、摄影、动作部门可读的制作型分镜
...
动作场面同时设计身体受力与摄影，按节拍选择蓄势、爆发和停顿，不固定套用景别顺序。特殊构图说明主体位置、裁切和空间锚点；特殊运镜说明起点、动作触发、路径、速度变化和落点。同一连续镜头可用 a/b/c 关键帧占用相邻格，注明无剪切，镜头总时长仅计算一次。九宫格保持等大，格内空间可以采用非常规切分。
